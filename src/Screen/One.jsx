    ...
    <View style={styles.navbar}>
      ...
      <View style={{height: responsiveHeight(50)}}>
        <LinearGradient
          ...
          <Text style={styles.buttonTexts1}>$10.00</Text>
          <LinearGradient
      ...
      <View style={styles.size}>
        <Text style={styles.choose} >Choose your <Text style={styles.sizetxt}>size</Text> </Text>
        <View style={{flexDirection: 'row'}}>
          <Text style={styles.buttonTextss}>Small</Text>
          ...
          <Text style={styles.buttonTextss}>Large</Text>
        </View>
      </View>
      <View >
        <Footer />
